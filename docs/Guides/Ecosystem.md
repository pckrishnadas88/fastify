...
- [`fastify-permissions`](https://github.com/pckrishnadas88/fastify-permissions) 🔐 Route-level
  permission middleware for Fastify — supports custom permission checks
